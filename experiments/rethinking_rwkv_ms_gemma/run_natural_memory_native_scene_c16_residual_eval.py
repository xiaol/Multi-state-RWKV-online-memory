#!/usr/bin/env python3
"""Generate the locked checkpoint-16 residual candidate on open TRAIN rows."""
...
SCHEMA = "rwkv_ms_natural_memory_native_scene_c16_residual_eval_shard.v1"
INPUT_SCHEMA = "rwkv_ms_natural_memory_native_scene_c16_residual_eval_input.v1"
