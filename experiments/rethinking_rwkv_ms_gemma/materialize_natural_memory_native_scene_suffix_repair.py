#!/usr/bin/env python3
"""Materialize the locked local-suffix repair endpoint unchanged."""
...
SCHEMA = "rwkv_ms_natural_memory_native_scene_suffix_repair_materialization.v1"
PATCH_SCHEMA = "rwkv_ms_natural_memory_native_scene_suffix_repair_patch.v1"
