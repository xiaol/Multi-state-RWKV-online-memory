...
PROTOCOL = SCRIPT_DIR / "natural_memory_native_recurrent_routed_query_value_hard_donor_protocol_v1.json"
PROTOCOL_PAYLOAD_SHA256 = "89f82ae37db80a191d13b923c2803addeaf876a797af67fb0ddc5c389a53aa99"
...
CONTROL_WEIGHTS = {
    ...
    "matched_donor_recurrent_state": 0.125,
...
def stage12_schedule(
    ...
    target_counts = {"attribution": 12, "narrative": 32, "scene": 20}
    selected_targets = {
