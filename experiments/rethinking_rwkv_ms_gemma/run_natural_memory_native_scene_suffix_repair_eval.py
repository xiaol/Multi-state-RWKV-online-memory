#!/usr/bin/env python3
"""Generate the locked local-suffix repair candidate on open TRAIN rows."""
...
SCHEMA = "rwkv_ms_natural_memory_native_scene_suffix_repair_eval_shard.v1"
INPUT_SCHEMA = "rwkv_ms_natural_memory_native_scene_suffix_repair_eval_input.v1"
